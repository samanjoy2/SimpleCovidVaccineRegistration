...
?>
    ...
    <img style="height:90px" src="imgs/bd.png">
    <img style="height:90px" src="imgs/mujib.jpg">
    </figure>
    ...
    <image src = "imgs/cooperators.jpg" width = "500" height = "115" alt = "Cooperators" class = "center">
